...
%%  Abstände für Aufzählungen und Titel
\setlist{
  itemsep=6pt,    % Abstand ZWISCHEN den einzelnen Listenpunkten (entspricht deinem Mini-Absatz)
  parsep=0pt,     % Abstand bei mehreren Absätzen innerhalb EINES Listenpunktes
  topsep=0pt,     % Abstand VOR und NACH der gesamten Liste zum normalen Fließtext
  partopsep=0pt   % Verhindert extra Abstände
}
% Syntax: \titlespacing*{Befehl}{Abstand links}{Abstand davor}{Abstand danach}
...
\@ifundefined{NewMarkClass}{%
    % Klassische Logik (TeXLive bis 2021)
    \renewcommand{\sectionmark}[1]{\markboth{#1}{}}%
    \renewcommand{\subsectionmark}[1]{\markright{#1}}%
}{%
    % Neuer Mark-Mechanismus (TeXLive ab 2022, noetig ab 2025)
    \NewMarkClass{sectiontitle}%
    \NewCommandCopy{\HAW@origmarkboth}{\markboth}%
    \DeclareRobustCommand*{\markboth}[2]{%
        \InsertMark{sectiontitle}{#1}%
        \HAW@origmarkboth{#1}{#2}%
    }%
    \renewcommand{\sectionmark}[1]{\markboth{#1}{}}%
    \renewcommand{\subsectionmark}[1]{\markright{#1}}%
    \renewcommand{\firstleftmark}{\FirstMark{sectiontitle}}%
}
\makeatother
...
\providecommand{\Nachname}{}
\providecommand{\Matrikelnummer}{}
\providecommand{\Datum}{}

%% Titel der Arbeit:
\providecommand{\Titel}{}
\providecommand{\TitelEN}{}

%% Typ der Arbeit
\providecommand{\Dokumentenart}{}
\providecommand{\Pruefungsart}{}

%% Prüfer und Firma:
\providecommand{\Erstpruefer}{}
\providecommand{\Zweitpruefer}{}
\providecommand{\Betreuer}{}
\providecommand{\Firmenname}{}
\providecommand{\Firma}{} 

%% ABSTRACT PAGE
\providecommand{\Stichworte}{}
\providecommand{\StichworteEN}{}
\providecommand{\Zusammenfassung}{}
\providecommand{\ZusammenfassungEN}{}